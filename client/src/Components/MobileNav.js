...
const MobileNav = (props) => {
  ...
  <Nav>
      <Nav.Item onClick={()=>window.location.assign('/')} >Home</Nav.Item>
      ...
      <Nav.Item onClick={()=>props.history.push('/movies/hindi')}>Hindi</Nav.Item>
      <Nav.Item onClick={()=>props.history.push('/join')}>Discussion</Nav.Item>
      <Dropdown title="Genre">
        <Dropdown.Item onClick={()=>props.history.push('/movies/action')}>Action</Dropdown.Item>
        <Dropdown.Item onClick={()=>props.history.push('/movies/horror')}>Horror</Dropdown.Item>
        <Dropdown.Item onClick={()=>props.history.push('/movies/animation')}>Animation</Dropdown.Item>
        {/* <Dropdown.Item onSelect={()=>props.history.push('/movies/documentaries')}>Documentaries</Dropdown.Item> */}
        <Dropdown.Item onClick={()=>props.history.push('/movies/drama')}>Drama</Dropdown.Item>
        <Dropdown.Item onClick={()=>props.history.push('/movies/romance')}>Romance</Dropdown.Item>
        <Dropdown.Item onClick={()=>props.history.push('/movies/comedy')}>Comedy</Dropdown.Item>
        <Dropdown.Item onClick={()=>props.history.push('/movies/crime')}>Crime</Dropdown.Item>
    ...
    <div>
      <InputGroup size='sm' inside className='searchbar' style={{maxWidth:'100vw'}}>
      <Input size='sm' placeholder='Enter Movies or series name...' onChange={searchh} onPressEnter={enterSearch}/>
