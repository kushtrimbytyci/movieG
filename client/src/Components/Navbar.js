...
const Navbari = (props) => {
  ...
  const guestLinks = (
    <Nav>
      <Nav.Item
        className="nav-underline-from-center"
      ...
      <Nav.Item
        ...
        onClick={() => props.history.push("/movies/hindi")}
      >
        <img
          src={new2}
          width="20px"
      ...
      <Dropdown title="Genre">
        <Dropdown.Item onSelect={() => props.history.push("/movies/action")}>
          Action
        </Dropdown.Item>
        <Dropdown.Item onSelect={() => props.history.push("/movies/animation")}>
          Animation
        </Dropdown.Item>
        <Dropdown.Item onSelect={() => props.history.push("/movies/crime")}>
          Crime
        </Dropdown.Item>
        <Dropdown.Item onSelect={() => props.history.push("/movies/comedy")}>
          Comedy
        </Dropdown.Item>
        {/* <Dropdown.Item onSelect={()=>props.history.push('/movies/documentaries')}>Documentaries</Dropdown.Item> */}
        <Dropdown.Item onSelect={() => props.history.push("/movies/drama")}>
          Drama
        </Dropdown.Item>
        <Dropdown.Item onSelect={() => props.history.push("/movies/horror")}>
          Horror
        </Dropdown.Item>
        <Dropdown.Item onSelect={() => props.history.push("/movies/romance")}>
          Romance
        </Dropdown.Item>
        <Dropdown.Item onSelect={() => props.history.push("/movies/fantasy")}>
          Fantasy
        </Dropdown.Item>
        <Dropdown.Item onSelect={() => props.history.push("/movies/thriller")}>
          Thriller
        </Dropdown.Item>
        <Dropdown.Item onSelect={() => props.history.push("/movies/mystery")}>
          Mystery
        </Dropdown.Item>
      </Dropdown>
    </Nav>
  ...
  const user = (
    <Nav>
      ...
      <Nav.Item onClick={() => props.history.push("/movies/documentaries")}>
        Documentaries
      </Nav.Item>
      <Nav.Item
        style={{ position: "relative" }}
      ...
      <Nav.Item onClick={() => props.history.push("/admindashboard")}>
        Admin dashboard
      </Nav.Item>
      <Dropdown title="Genre">
        <Dropdown.Item onSelect={() => props.history.push("/movies/action")}>
